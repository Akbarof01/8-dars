    ...
    <div className='body'>
     ...
     <Header>
      ...
      {/* Rest of your components */}
        ...
        <Ul >
          ...
          <option value="rus">Rus-Tilli</option>
          </select>
        </Ul>
      </NAV>
     </Header>
     <div className='big-box'>
      <div className='container'>
       <h1 className='hed'>Hi       <svg width="65" height="65" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<p>I design and develop experiences that make people’s lives simpler through Web and Mobile apps.I work with FIgma , HTML5, CSS3, JavaScript, React, ReactNative and Flutter.</p>
   <button className='hire'>HiIRE ME</button>
